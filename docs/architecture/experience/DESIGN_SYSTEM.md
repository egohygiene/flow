...
This document defines reusable semantic language for Flow's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain fluid, cinematic, explainable, and consistent across specialized tool transitions while allowing product-specific identity to vary inside Ego Hygiene's broader family.

## Evidence and uncertainty

- **Observed:** The repository README establishes the intended boundary as the unified planning, execution, provenance, validation, recovery, and experience layer for independently useful media and publication tools; significant implementation remains incomplete.
